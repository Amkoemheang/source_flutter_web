...
class MyHomePageTable extends StatefulWidget {
  MyHomePageTable({Key key, @required this.title}) : super(key: key);
  final String title;

  @override
  _MyHomePageTableState createState() => _MyHomePageTableState();
}

class _MyHomePageTableState extends State<MyHomePageTable> {
  ...
  List<Widget> _getTitleWidget() {
    return [
      ...
      _getTitleItemWidget('Photo', 200),
      _getTitleItemWidget('Phone', 200),
      _getTitleItemWidget('Register', 200),
      _getTitleItemWidget('Termination', 300),
    ];
  }
